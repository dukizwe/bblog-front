...
export default memo(function PostCard({ post }) {
          ...
          return (
                    <TransitionGroup appear={true} enter={false} className="post__card">
                              <CSSTransition in={true} timeout={1000} classNames="fluid" nodeRef={nodeRef}>
                                        <div className="card__content"  ref={nodeRef}>
