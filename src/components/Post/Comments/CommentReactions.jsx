...
export default function CommentReactions ({commentId, reactions: initialReactions}) {
          ...
          const likeComment = async (e) => {
                    ...
                    if(!user) return
                    setLoading(true)
                    const reactions = await fetchApi(`/comments/${commentId}/likes`, {
                              method: 'PUT'
                    })
                    setLoading(false)
          ...
          const dislikeComment = async (e) => {
                    ...
                    if(!user) return
                    setLoading(true)
                    const reactions = await fetchApi(`/comments/${commentId}/dislikes`, {
                              method: 'PUT'
                    })
                    setLoading(false)
                    setReactions(reactions)
          ...
          const ReplyButton = () => {
                    ...
                    <div className="replies__count">
                              <button>
                                        ...
                                        <span>{minNumber(initialReactions.replies)}</span>
                              </button>
                    </div>)
          }
          return (
